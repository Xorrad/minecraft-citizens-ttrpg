package me.xorrad.ttrpg.generators;
 ...
 *
 * @example
 * RinkworksGenerator generator = new RinkworksGenerator("sV'i");
...
public class RinkworksGenerator
{
    // Middle Earth
    ...
    protected ArrayList<RinkworksGenerator> generators = new ArrayList<RinkworksGenerator>();

    public RinkworksGenerator(String pattern)
    {
        this(pattern, true, true);
    }

    public RinkworksGenerator(String pattern, boolean collapseTriples, boolean capitalizeFirst)
    {
        RinkworksGenerator last;
        ...
        RinkworksGenerator g = top.produce();
        if (collapseTriples)
            g = new Collapser(g);
        if (capitalizeFirst)
            g = new Capitalizer(g);
    ...
    RinkworksGenerator(ArrayList<RinkworksGenerator> generators)
    {
    ...
    {
        int total = 1;
        for (RinkworksGenerator g : this.generators)
    ...
    public void add(RinkworksGenerator g)
    {
    ...
    public abstract class Group
    {
        ...
        private ArrayList<RinkworksGenerator> set = new ArrayList<RinkworksGenerator>();
        ...
        public RinkworksGenerator produce()
        {
        ...
        {
            if (this.set.size() == 0)
                this.set.add(new Sequence(new ArrayList<RinkworksGenerator>()));
            this.set.add(new Sequence(new ArrayList<RinkworksGenerator>()));
        }
        ...
        {
            RandomPicker g = new RandomPicker(new ArrayList<RinkworksGenerator>(), random);
    ...
    class GroupSymbol extends Group
    {
        ...
        {
            RinkworksGenerator g = new RandomPicker(new ArrayList<RinkworksGenerator>(), random);
    ...
    class RandomPicker extends RinkworksGenerator
    {
        private Random random;

        public RandomPicker(ArrayList<RinkworksGenerator> generators, Random random)
        {
            super(generators);
            this.random = random;
        }
    ...
    class Sequence extends RinkworksGenerator
    {
        public Sequence(ArrayList<RinkworksGenerator> generators)
        {
            super(generators);
        }
    }

    class Literal extends RinkworksGenerator
    {
        private String value;

        public Literal(String value)
        {
            super(new ArrayList<RinkworksGenerator>());
            this.value = value;
        }
    ...
    class Reverser extends RinkworksGenerator
    {
        public Reverser(RinkworksGenerator generator)
        {
            super(new ArrayList<RinkworksGenerator>()
            {{
                add(generator);
    ...
    class Capitalizer extends RinkworksGenerator
    {
        public Capitalizer(RinkworksGenerator generator)
        {
            super(new ArrayList<RinkworksGenerator>()
            {{
                add(generator);
    ...
    class Collapser extends RinkworksGenerator
    {
        public Collapser(RinkworksGenerator generator)
        {
            super(new ArrayList<RinkworksGenerator>()
            {{
                add(generator);
